      ...
      {config.enabled && (
        <>
          ...
          <p className="mt-2 text-xs text-slate-500">
            Qualité équilibrée 720p à 30 i/s : environ {estimatedMegabytes} Mo pour 7 h 30. Chaque tranche de 30 minutes crée deux vidéos séparées et plein cadre, une AVANT et une ARRIÈRE ultra-grand-angle 0,5×, puis la tranche suivante démarre automatiquement. Un bandeau discret avec l’angle, la date et l’heure apparaît uniquement pendant les trois premières secondes. Le micro est d’abord écrit en PCM 48 kHz dans un fichier résistant aux extinctions brutales, puis synchronisé avec l’horloge réelle de chaque caméra avant d’être ajouté aux deux vidéos. Le démarrage n’est confirmé qu’après écriture réelle des deux angles et du micro. iOS applique le mode choisi : Automatique, Standard, Isolement de la voix ou Large spectre. Les sources restent dans le stockage durable jusqu’à confirmation de l’import des deux vidéos dans Photos, puis elles sont récupérées automatiquement après une interruption. Les vidéos sont exclues de Supabase et des sauvegardes JSON.
          </p>
          <button
            type="button"
